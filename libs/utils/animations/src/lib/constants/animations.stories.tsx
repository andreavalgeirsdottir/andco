...
import { MOTIONS_VARIANTS, VARIANT_STATES } from './variants';
	...
	return (
		<div className={styles.div}>
			<motion.ul
				...
				{...parent}
				animate={show ? VARIANT_STATES.in : VARIANT_STATES.out}
			>
				{title.map((t) => (
					<motion.li key={t} className={styles.title} {...child}>
						{t}
					</motion.li>
				))}
			</motion.ul>
