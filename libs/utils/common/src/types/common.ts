...
export type ConditionalType<
	...
	IfTrue extends object,
	IfFalse extends object,
> = Condition extends true
	? IfTrue & Omit<NilRecord<IfFalse>, keyof IfTrue>
	: IfFalse & Omit<NilRecord<IfTrue>, keyof IfFalse>;

/**
 * The `forwardRef` function doesn't allow you by default to extend the component object with additional properties.
 * This is a TS helper type which allows you to extend.
 *
 * @example
 * ```tsx
  type Props = {}

  export const Checkbox: ExtendableForwardRef<Props, { useCheckbox?: typeof useCheckbox }> = forwardRef((
		props,
		ref: Ref<HTMLInputElement>,
	) => <div></div>);

	const useCheckbox = () => { console.log('hey') }

	Checkbox.useCheckbox = useCheckbox;
 * ```
 */
export type ExtendableForwardRef<P extends object, T extends object = {}> = React.ForwardRefExoticComponent<P> & T;
