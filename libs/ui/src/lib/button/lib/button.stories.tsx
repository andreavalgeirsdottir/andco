...
const InlineTemplate: Story<ButtonProps> = (args) => {
	return (
		<p>
			Lorem ipsum dolor sit amet <Button {...args}>adipisicing elit</Button>. Tenetur facilis laudantium
		</p>
	);
};

export const ButtonInlineStory = InlineTemplate.bind({});

ButtonInlineStory.storyName = 'Inline in context';

ButtonInlineStory.args = {
	variant: 'inline',
	size: 'medium',
};

ButtonInlineStory.argTypes = { ...ButtonStory.argTypes };

ButtonInlineStory.parameters = { ...ButtonStory.parameters };
